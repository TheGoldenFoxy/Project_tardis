...
@Mod("project_tardis")
public class ProjectTardisMod {
	public static final Logger LOGGER = LogManager.getLogger(ProjectTardisMod.class);
	public static final String MODID = "project_tardis";

	public ProjectTardisMod() {
	...
	private static class ProjectTardisModFMLBusEvents {
		private final ProjectTardisMod parent;

		ProjectTardisModFMLBusEvents(ProjectTardisMod parent) {
			this.parent = parent;
		}
